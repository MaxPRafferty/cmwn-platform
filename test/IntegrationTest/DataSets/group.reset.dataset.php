...
return [
    ...
    'users'            => [
        ...
        [
            'user_id'      => 'english_student_code',
            'username'     => 'english_student_code',
            'email'        => 'english_student_code@ginasink.com',
            'code'         => 'foobar12',
            'type'         => 'CHILD',
            'password'     => '$2y$10$b53JWhhPjSyHvbvaL0aaD.9G3RKTd4pZn6JCkop6pkqFYDrEPJTC.',
            'first_name'   => 'John',
            ...
            'updated'      => '2016-04-27 10:48:46',
            'deleted'      => null,
            'code_expires' => '2016-04-27 10:48:46',
            'super'        => '0',
            'external_id'  => '8675309',
        ],
        [
        ...
        [
            'user_id'      => 'math_student_code',
            'username'     => 'math_student_code',
            'email'        => 'math_student_code@ginasink.com',
            'code'         => 'foobar12',
            'type'         => 'CHILD',
            'password'     => '$2y$10$b53JWhhPjSyHvbvaL0aaD.9G3RKTd4pZn6JCkop6pkqFYDrEPJTC.',
            'first_name'   => 'WILLIS',
        ...
        [
            'user_id'      => 'other_student_code',
            'username'     => 'other_student_code',
            'email'        => 'other_student_code@manchuck.com',
            'code'         => 'foobar12',
            'type'         => 'CHILD',
            'password'     => '$2y$10$b53JWhhPjSyHvbvaL0aaD.9G3RKTd4pZn6JCkop6pkqFYDrEPJTC.',
            'first_name'   => 'Chuck',
