...
/**
 * This class determines the relationship between two given users - the user who is logged in and user who is requested
 */
class SecurityUserService implements SecurityUserServiceInterface
{
    /**
     * @var TableGateway
     */
