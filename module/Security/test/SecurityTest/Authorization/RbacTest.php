...
class RbacTest extends TestCase
{
    ...
    public function roleEntityProvider()
    {
        return [
            ...
            'Principal (adult)'                  => ['principal.adult', 'adult', 1],
            ...
            'Neighbor (group)'                   => ['neighbor.adult.adult', 'group', 0],
            'Neighbor (organization)'            => ['neighbor.adult.adult', 'organization', 0],
            'Neighbor (adult)'                   => ['neighbor.adult.adult', 'adult', 1],
            'Neighbor (child)'                   => ['neighbor.adult.adult', 'child', 0],
            'Neighbor (me)'                      => ['neighbor.adult.adult', 'me', 0],
